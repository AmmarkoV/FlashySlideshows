...
g++ main.cpp environment.cpp load_images.cpp load_textures.cpp sound.cpp directory_listing.cpp directory_sorting.cpp directory_transactions.cpp slideshow.cpp controls.cpp camera_control.cpp pictures_control.cpp effects.cpp visuals.cpp scene_objects.cpp memory_hypervisor.cpp joystick.cpp math_3d.cpp image_sensing.cpp transitions/basic_transition.cpp wxwidgets_stuff.cpp -lglut -lGL -lGLU -lXxf86vm -lopenal -lalut `wx-config --libs` `wx-config --cxxflags` $OpenCVStuff -L. -o bin/Release/FlashySlideShow
