...
BUILD_FLASHY_SLIDESHOWS="g++ gcc wx-common libwxgtk3.0-dev libopenal-dev libalut0 libalut-dev freeglut3 freeglut3-dev libxxf86vm-dev libjpeg-dev  libpng-dev libglew-dev"
